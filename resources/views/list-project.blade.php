                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                            ...
                                            <form action="{{route('project.edit', $project->id)}}">
                                                <div class="modal-body" style="margin-left: 5%; margin-right: 5%;">
                                                    ...
                                                    <div class="row" style="margin-top: 4%;">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <h4>Tempo de desenvolvimento:</h4> <input type="text" name="temp" value="{{$project->value}}" class="form-control" placeholder="Nome">
                                                        </div>
                                                    </div>
                                    ...
                                    <tr id="aProjeto">
                                        <td id="center">{{$project->id}} {{$project->id_User}} </td>
                                        ...
                                        <td id="center">
                                            ...
                                            &nbsp;
                                            <a title="Apoiar" data-toggle="modal" data-target="#modalApoiador_p{{$project->id}}">
                                                <i class="fa fa-thumbs-up"></i>
                                            </a>
                                            
                                            &nbsp;
                                            <a href="{{route('project.finish', $project->id)}}"> <i class="fa fa-ban"></i> </a>
                                        </td>
                                    </tr>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <form action="{{route('project.create')}}">
                        <div class="modal-body" style="margin-left: 5%; margin-right: 5%;">
                            <div class="row" style="margin-top: 2%;">
                                <div class="col-xs-12">
                                    <h4>Nome:</h4> <textarea class="form-control" name="name" placeholder="Nome" style="height: 100px; resize: none;"></textarea>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 2%;">
                                <div class="col-xs-12">
